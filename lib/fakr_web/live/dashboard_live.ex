      ...
      <div class="max-w-5xl mx-auto">
        <div class="flex items-center justify-between mb-8">
          ...
          <.link
            ...
            class="inline-flex items-center px-4 py-2 bg-indigo text-white rounded-lg hover:bg-indigo/90 transition font-medium"
          >
        ...
        >
          ...
          <.link
            navigate={~p"/collections/new"}
            class="inline-flex items-center mt-6 px-4 py-2 bg-indigo text-white rounded-lg hover:bg-indigo/90 transition"
          >
            Create Collection
          </.link>
        </div>
