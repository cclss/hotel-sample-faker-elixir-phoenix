  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope}>
      <div class="max-w-5xl mx-auto">
        <div class="mb-8">
          <h1 class="text-3xl font-bold text-navy">Explore</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <.link :for={collection <- @collections}
          ...
          >
            ...
            <div class="flex items-center gap-3 text-sm text-gray-400">
              ...
              <span class="text-xs text-blue ml-auto">View &rarr;</span>
            </div>
          </.link>
        </div>

        <div :if={@has_more} class="text-center mt-8">
          <button phx-click="load_more" class="px-6 py-2 bg-gray-100 text-navy rounded-lg hover:bg-gray-200 transition text-sm font-medium">
            Load more
          </button>
        </div>
      </div>
